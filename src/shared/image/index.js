    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error_1 = _b.sent();
                    console.error("Error fetching S3 folder contents:", error_1);
                    throw error_1;
...
var uploadImages = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                uploadPromises = keys.map(function (key) { return __awaiter(void 0, void 0, void 0, function () {
                    var filePath, fileContent;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                filePath = path_1.default.join(folderPath, key);
